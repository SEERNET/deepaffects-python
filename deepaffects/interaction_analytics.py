...
class AnalyticsApi():
    ...
    def async_analytics(
        ...
        params = {'apikey': AnalyticsApi.API_KEY}
        if webhook:
        ...
        output = requests.post(url=AnalyticsApi.URL, json=request_json, params=params).json()
