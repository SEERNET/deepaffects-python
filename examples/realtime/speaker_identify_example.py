...
import time
from deepaffects_realtime import get_segment, make_input_audio_segments, encode_to_base64, get_deepaffects_client, audio_segment_to_base64

TIMEOUT_SECONDS = 300
API_KEY = "YOUR_API_KEY"
file_path = "FILE_PATH"
userIds = ["list of enrolled userids for indentification"]
    ...
    for i, chunk in enumerate(audio_clip[::15500]):
        ...
        if previous_chunk is not None:
            ...
            if len(chunk) <= 3000:
                ...
                audio_segment, offset = get_segment(
                    previous_chunk, offset, i, userIds)
                yield audio_segment
        ...
        if previous_chunk is None:
            if len(audio_clip) < 15500:
                audio_segment, offset = get_segment(chunk, offset, i, userIds)
                yield audio_segment
            previous_chunk = chunk
